...
####DEL DIEGOcomplete_db_conn = connect_to_database('/Storage/data1/isabella.gallego/IC/SRA_dbs/complete_db.db')
####DEL DIEGO
####DEL DIEGOif complete_db_conn is not None:
####DEL DIEGO    pmids_from_db = extract_pmids_from_database(complete_db_conn)
####DEL DIEGOelse:
####DEL DIEGO    print("No se pudo conectar a la base de datos. Deteniendo la ejecución.") # Control de errores
####DEL DIEGO
####DEL DIEGO#pmids_from_db = extract_pmids_from_database(complete_db_conn)
